...
var displayMap = function displayMap() {
  console.log('THE MAP NEEDS MONEY...');
};
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            console.log(res);
            if (res.data.status === 'success') location.reload(true); // reload(true) prevent caching and getting the same data (getting the page from the server)
...
var logoutButton = document.querySelector('.nal__el--logout');
